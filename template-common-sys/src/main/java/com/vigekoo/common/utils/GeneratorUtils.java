...
import com.vigekoo.entity.SysColumn;
import com.vigekoo.entity.SysTable;
...
public class GeneratorUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			try {
				//添加到zip
				zip.putNextEntry(new ZipEntry(getFileName(template, classNameTemp, classnameTmep, config.getString("package"), config.getString("controllerPackage"))));
	 ...
	 * 获取文件名
	 */
	public static String getFileName(String template, String className, String classname, String packageName,String controllerPackageName){
